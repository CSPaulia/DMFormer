...
data_dir = './data'
train_data_path = '/root/GenGM/data/midiAll/train'
dev_data_path = '/root/GenGM/data/midiAll/validate'
test_data_path = '/root/GenGM/data/midiAll/test'
model_path = './experiment'
log_path = './experiment/train.log'
output_path = './experiment/output.txt'
label_mapping = '/root/GenGM/utils/DrumMusic.yaml'
